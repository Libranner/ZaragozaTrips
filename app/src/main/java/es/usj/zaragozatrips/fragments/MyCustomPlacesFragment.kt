 ...
 * [MyCustomPlacesFragment.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [MyCustomPlacesFragment.newInstance] factory method to
...
class MyCustomPlacesFragment : Fragment() {
    ...
    private fun onDataReady(places: Array<Place>) {
        ...
        recyclerView.adapter = MyCustomPlaceRecyclerViewAdapter(DataManager.places.toTypedArray(), mCustomListener)
